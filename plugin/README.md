...
messages are evaluated together with their following tool results. For tool
results, Jev chooses keep, truncate, or drop; truncation keeps the assistant's
tool call and a short result head followed by a re-run marker.
